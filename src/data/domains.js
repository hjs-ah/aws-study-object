// src/data/domains.js — SAA-C03 domain definitions (legacy export)
// Used by ConceptMap, ArchitectureTrap, GlossaryTerms components.
// New code should use certifications.js + getCert().

const ALL_TABS = ['concepts', 'scenarios', 'architecture-trap', 'lab', 'cheat-sheet']
